...
#largest county will have the largest number of votes

largest_county_name = ""

#largest county voter turnout is the county with the most votes
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (iterated_county_votes > largest_county_votes) and (countyvote_percentage > largest_county_percentage):
